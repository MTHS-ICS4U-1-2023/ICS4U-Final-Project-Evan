...
def process_audio(indata):
    ...
    hann_samples = process_audio.window_samples * HANN_WINDOW
    ...
    process_audio.noteBuffer.insert(0, closest_note)  # note that this is a ringbuffer
    process_audio.noteBuffer.pop()

    if process_audio.noteBuffer.count(process_audio.noteBuffer[0]) == len(process_audio.noteBuffer):
        return [closest_note]
    else:
        return ["..."]
